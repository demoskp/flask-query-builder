...
def test_assert_exception_not_raised_when_sort_not_allowed_when_raise_exceptions_is_disabled(db_session, request_context, models):
    ...
    with request_context("/?sort=last_name"):
        users = QueryBuilder(models.User, raise_exceptions=False).allowed_sorts([
